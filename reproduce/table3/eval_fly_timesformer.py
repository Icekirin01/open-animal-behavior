"""
eval_fly_timesformer_ratio.py — Fly Copulation TimeSformer Evaluation (frame-wise)

Usage:
    python eval_fly_timesformer_ratio.py --model_path checkpoints/fly_timesformer_ratio/model.pth
"""
...
def main():
    ...
    print(f"\n{'='*70}")
    print("Fly Copulation — TimeSformer Evaluation (frame-wise)")
    print(f"{'='*70}")
