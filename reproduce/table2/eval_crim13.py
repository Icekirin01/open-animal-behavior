"""
eval_crim13.py — CRIM13 Test Evaluation: Frame-wise with Confusion Matrix (13 classes)

Usage:
    python eval_crim13.py --model_path checkpoints/crim13/model.pth
    python eval_crim13.py --model_path model.pth --test_video_dir data/test/videos --save_cm cm.png
"""
...
def parse_args():
    p = argparse.ArgumentParser(description="Evaluate Video Swin-T on CRIM13 test set")
    p.add_argument("--model_path", type=str, required=True)
    p.add_argument("--test_video_dir", type=str, default="data/crim13/videos/test")
    p.add_argument("--test_label_dir", type=str, default="data/crim13/labels")
...
def main():
    ...
    print(f"\n{'='*70}")
    print("CRIM13 Test Evaluation — Frame-wise (MLP Head, 13 classes)")
    print(f"{'='*70}")
