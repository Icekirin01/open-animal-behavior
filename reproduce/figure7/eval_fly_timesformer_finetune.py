"""
eval_fly_timesformer_finetune.py — Evaluate Fine-tuned TimeSformer on Lab Dataset (frame-wise)

Usage:
    python eval_fly_timesformer_finetune.py --model_path checkpoints/fly_timesformer_finetune/model.pth
"""
...
def main():
    ...
    print(f"\n{'='*70}")
    print("Fly Copulation — Fine-tuned TimeSformer Evaluation (frame-wise)")
    print(f"{'='*70}")
